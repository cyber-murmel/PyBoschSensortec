...
class BMI160:
    ...
    # @param mode New DLPF configuration setting
    # @see get_accel_dlpf_mode()
    def set_accel_dlpf_mode(self, mode):
    ...
    # @see get_x_accel_offset()
    # @see registers.OFFSET_6
    def set_accel_offset_enabled(self, enabled):
    ...
    # These can be retrieved using the get_x_accel_offset() methods.
    ...
    #
    # To enable offset compensation, @see set_accel_offset_enabled()
    #
    # @param target X-axis target value (0 = 0g, 1 = +1g, -1 = -1g)
    # @see set_accel_offset_enabled()
    # @see get_x_accel_offset()
    # @see registers.FOC_CONF
    # @see registers.CMD
    def auto_calibrate_x_accel_offset(self, target):
        foc_conf = 0
        if (target == 1):
    ...
    # These can be retrieved using the get_y_accel_offset() methods.
    # Note that this procedure may take up to 250ms to complete.
    #
    # IMPORTANT: The user MUST ensure NO movement and correct orientation of the
    # BMI160 device occurs while this auto-calibration process is active.
    ...
    # @see set_accel_offset_enabled()
    # @see get_y_accel_offset()
    # @see registers.FOC_CONF
    # @see registers.CMD
    def auto_calibrate_y_accel_offset(self, target):
        foc_conf = 0
        if (target == 1):
    ...
    # These can be retrieved using the get_z_accel_offset() methods.
    # Note that this procedure may take up to 250ms to complete.
    #
    # IMPORTANT: The user MUST ensure NO movement and correct orientation of the
    # BMI160 device occurs while this auto-calibration process is active.
    ...
    # @see set_accel_offset_enabled()
    # @see get_z_accel_offset()
    # @see registers.FOC_CONF
    # @see registers.CMD
    def auto_calibrate_z_accel_offset(self, target):
        foc_conf = 0
        if (target == 1):
    ...
    # For auto-calibration, @see auto_calibrate_x_accel_offset().
    # @see get_x_accel_offset()
    # @see registers.OFFSET_0
    ...
    # This is used for applying manual calibration constants if required.
    # For auto-calibration, @see auto_calibrate_y_accel_offset().
    # @see get_y_accel_offset()
    # @see registers.OFFSET_1
    ...
    # This is used for applying manual calibration constants if required.
    # For auto-calibration, @see auto_calibrate_z_accel_offset().
    # @see get_z_accel_offset()
    # @see registers.OFFSET_2
    ...
    # @see get_x_gyro_offset()
    # @see registers.OFFSET_6
    def set_gyro_offset_enabled(self, enabled):
    ...
    #
    # To enable offset compensation, @see set_gyro_offset_enabled()
    # @see set_gyro_offset_enabled()
    # @see get_x_gyro_offset()
    # @see get_y_gyro_offset()
    # @see get_z_gyro_offset()
    # @see registers.FOC_CONF
    # @see registers.CMD
    ...
    # This is used for applying manual calibration constants if required.
    # For auto-calibration, @see auto_calibrate_gyro_offset().
    # @see get_x_gyro_offset()
    # @see registers.OFFSET_3
    # @see registers.OFFSET_6
    ...
    def get_freefall_detection_threshold(self):
    ...
    # @see registers.INT_LOWHIGH_1
    def set_freefall_detection_threshold(self, threshold):
    ...
    def get_freefall_detection_duration(self):
    ...
    # @see registers.INT_LOWHIGH_0
    def set_freefall_detection_duration(self, duration):
    ...
    # sensitivity range (@see get_full_scale_accel_range()):
    #
    # <pre>
    ...
    def get_shock_detection_threshold(self):
    ...
    # @see get_shock_detection_threshold()
    # @see registers.INT_LOWHIGH_4
    def set_shock_detection_threshold(self, threshold):
    ...
    def get_shock_detection_duration(self):
    ...
    # @see get_freefall_detection_duration()
    # @see registers.INT_LOWHIGH_3
    def set_shock_detection_duration(self, duration):
    ...
    def get_step_detection_mode(self):
        ret_step_conf0 = 0
        ret_min_step_buf = 0
    ...
    # @see registers.STEP_CONF_1
    # @see BMI160StepMode
    def set_step_detection_mode(self, mode):
        step_conf0 = 0
        min_step_buf = 0
    ...
    # Once enabled and configured correctly (@see set_step_detection_mode()), the
    # BMI160 will increment a counter for every step detected by the accelerometer.
    # To retrieve the current step count, @see get_step_count().
    #
    ...
    def get_step_count_enabled(self):
    ...
    # @see get_step_count_enabled()
    # @see registers.STEP_CONF_1
    # @see definitions.STEP_CNT_EN_BIT
    def set_step_count_enabled(self, enabled):
    ...
    # @see set_step_count_enabled()
    # @see set_step_detection_mode()
    ...
    def get_motion_detection_threshold(self):
    ...
    def get_motion_detection_duration(self):
    ...
    # @see get_motion_detection_duration()
    # @see registers.INT_MOTION_0
    def set_motion_detection_duration(self, samples):
    ...
    # (@see get_full_scale_accel_range()) as follows:
    #
    # <pre>
    # Full Scale Range | LSB Resolution
    # -----------------+----------------
    ...
    def get_zero_motion_detection_threshold(self):
    ...
    def get_zero_motion_detection_duration(self):
    ...
    def get_tap_detection_threshold(self):
    ...
    # @see get_tap_detection_threshold()
    # @see registers.INT_TAP_1
    def set_tap_detection_threshold(self, threshold):
    ...
    def get_tap_shock_duration(self):
    ...
    # @see registers.INT_TAP_0
    def set_tap_shock_duration(self, duration):
    ...
    def get_double_tap_detection_duration(self):
    ...
    # @see get_double_tap_detection_duration()
    # @see registers.INT_TAP_0
    def set_double_tap_detection_duration(self, duration):
    ...
    #*/
    def get_int_freefall_enabled(self):
    ...
    # @see definitions.LOW_G_EN_BIT
    #*/
    def set_int_freefall_enabled(self, enabled):
    ...
    #*/
    def get_int_shock_enabled(self):
    ...
    # @param enabled New interrupt enabled status
    # @see get_int_shock_enabled()
    # @see registers.INT_EN_1
    # @see definitions.HIGH_G_EN_BIT
    #*/
    def set_int_shock_enabled(self, enabled):
    ...
    #*/
    def get_int_motion_enabled(self):
    ...
    #*/
    def get_int_zero_motion_enabled(self):
    ...
    #*/
    def get_int_double_tap_enabled(self):
    ...
    # @see definitions.D_TAP_EN_BIT
    #*/
    def set_int_double_tap_enabled(self, enabled):
    ...
    #*/
    def get_int_fifo_buffer_full_enabled(self):
        return 0 != (self._reg_read_bits(registers.INT_EN_1, definitions.FFULL_EN_BIT, 1))

    ## Set FIFO Buffer Full interrupt enabled status.
    # @param enabled New interrupt enabled status
    # @see get_int_fifo_buffer_full_enabled()
    # @see registers.INT_EN_1
    # @see definitions.FFULL_EN_BIT
    #*/
    def set_int_fifo_buffer_full_enabled(self, enabled):
    ...
    # @see registers.INT_EN_1
    # @see definitions.DRDY_EN_BIT
    def set_int_data_ready_enabled(self, enabled):
    ...
    # @see registers.FIFO_CONFIG_1
    def get_gyro_fifo_enabled(self):
    ...
    # @see get_gyro_fifo_enabled()
    # @see registers.FIFO_CONFIG_1
    def set_gyro_fifo_enabled(self, enabled):
    ...
    # FIFO. See @ref get_fifo_header_mode_enabled().
    #
    ...
    def get_fifo_header_mode_enabled(self):
    ...
    # @see get_fifo_header_mode_enabled()
    # @see registers.FIFO_CONFIG_1
    # @see definitions.FIFO_HEADER_EN_BIT
    def set_fifo_header_mode_enabled(self, enabled):
    ...
    # get_gyro_fifo_enabled() and get_accel_fifo_enabled()).
    #
    # The data frame format depends on the enabled data sources and also on
    # the FIFO header-mode setting (@see get_fifo_header_mode_enabled()).
    #
    ...
    def get_fifo_bytes(self, *data, length):
        # TODO fix here
        if (length):
    ...
    def get_int_freefall_status(self):
    ...
    def get_int_double_tap_status(self):
    ...
    def get_x_neg_shock_detected(self):
    ...
    # @see definitions.HIGH_G_SIGN_BIT
    # @see definitions.HIGH_G_1ST_X_BIT
    def get_x_pos_shock_detected(self):
        status = self._reg_read(registers.INT_STATUS_3)
    ...
    def get_y_neg_shock_detected(self):
        status = self._reg_read(registers.INT_STATUS_3)
    ...
    # @see definitions.HIGH_G_SIGN_BIT
    # @see definitions.HIGH_G_1ST_Y_BIT
    def get_y_pos_shock_detected(self):
        status = self._reg_read(registers.INT_STATUS_3)
    ...
    def get_z_neg_shock_detected(self):
        status = self._reg_read(registers.INT_STATUS_3)
    ...
    # @see definitions.HIGH_G_SIGN_BIT
    # @see definitions.HIGH_G_1ST_Z_BIT
    def get_z_pos_shock_detected(self):
        status = self._reg_read(registers.INT_STATUS_3)
    ...
    def get_int_motion_status(self):
    ...
    # 15            | latched until cleared (@see reset_interrupt())
    # </pre>
    #
    ...
    # @set_full_scale_accel_range. For each full scale setting, the accelerometers'
    ...
    # @set_full_scale_gyro_range(). For each full scale setting, the gyroscopes'
    # sensitivity per LSB is shown in the table below:
    #
    # <pre>
    # Full Scale Range   | LSB Sensitivity
